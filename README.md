...
[![GoDoc](https://godoc.org/github.com/gooxion/radius?status.svg)](https://godoc.org/github.com/gooxion/radius)
[![CircleCI](https://circleci.com/gh/layeh/radius/tree/master.svg?style=shield)](https://circleci.com/gh/layeh/radius/tree/master)

## Installation

    go get -u github.com/gooxion/radius
...
Included in this package is the command line program `radius-dict-gen`. It can be installed with:
    ...
    go get -u github.com/gooxion/radius/cmd/radius-dict-gen
...
Included in this repository are sub-packages of generated helpers for commonly used RADIUS attributes, including [`rfc2865`](https://godoc.org/github.com/gooxion/radius/rfc2865) and [`rfc2866`](https://godoc.org/github.com/gooxion/radius/rfc2866).
...
Tim Cooper (<tim.cooper@github.com/gooxion>)
